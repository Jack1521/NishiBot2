...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*JackV2•Powered By Xeon*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/HEiSfugQ3A2AA3ZjLnhMSO', "groupName": `©Jack-Official™✨.`, "footerText": "*JackV2•Powered By Xeon*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
${z}🤤 ${prefix}animemenu${z}
    Don't pm or call the bot any problem? Contact: 989035024059
┗━━━━━━━━━━━━━━━━━`
buttons = [
{buttonId:`scbot`, buttonText: {displayText: 'My Github🔖'}, type: 1},
...
const grup = {
    contentText: `${stamtus}`,
    footerText: `_This Bot was ReCoded By Jack.. The Core Code Powered By Nishi and Xeon_`,
    buttons: buttons,
    headerType: 1
}
...
const funyo = {
    contentText: `${stamtus}`,
    footerText: `_This Bot was ReCoded By Jack.. The Core Code Powered By Xeon_`,
    buttons: buttons,
    headerType: 1
}
...
//LUPA
 ...
 footerText: 'JackV2•Powered By Xeon',
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `JackV2•Powered By Xeon`,
							"hydratedButtons": [
								{
									"quickReplyButton": {
...
const btngrass = {
    contentText: `${anu}`,
    footerText: '*_JackV2•Powered By Xeon_*',
    buttons: punten,
    headerType: 1
}
